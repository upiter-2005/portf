...
$(function(){$(".serv").equalHeights(),$(".potf-item").equalHeights(),$(".popup-cont").magnificPopup({type:"inline"}),document.documentElement.clientWidth>1024&&($("#fullpage").fullpage(),$(".rev").equalHeights()),$(".header-but").magnificPopup({items:{src:"#test-popup",type:"inline"}}),$(".bot-send").on("click",function(){$("#bot-form").submit()})});